    ...
    const validarFormulario = (e) => {
        switch (e.target.name) {
            case "usuario":
                ...
                //     document.getElementById('grupo_1_usuario').classList.remove('formulario_1_grupo-incorrecto');
                //     document.getElementById('grupo_1_usuario').classList.add('formulario_1_grupo-correcto');
                //     document.querySelector('grupo_1_usuario i').classList.remove('fa-check-circle');
                //     document.querySelector('grupo_1_usuario i').classList.add('fa-times-circle');
                //     document.querySelector('grupo_1_usuario .formulario_1_input-error') .classList.remove('formulario_1_input-error-activo');
                // }else{
                //     document.getElementById('grupo_1_usuario').classList.add('formulario_1_grupo-incorrecto');
                //     document.getElementById('grupo_1_usuario').classList.add('formulario_1_grupo-incorrecto');
                //     document.querySelector('#grupo_1_usuario i').classList.add('fa-times-circle');
                //     document.querySelector('#grupo_1_usuario i').classList.remove('fa-check-circle');
                //     document.querySelector('grupo_1_usuario .formulario_1_input-error') .classList.add('formulario_1_input-error-activo');
                // }}}
            break;
